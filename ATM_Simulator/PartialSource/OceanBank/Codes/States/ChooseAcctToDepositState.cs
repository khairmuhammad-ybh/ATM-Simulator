    ...
    class ChooseAcctToDepositState : State
    {
        ...
        public override State handleLeft1BTNClick()
        {
            ...
            if (session)
            {
                if (left1BTN.Text != "")
                {
                    nextStep = new DepositState(mainForm, language, left1BTN.Text);
        ...
        public override State handleLeft2BTNClick()
        {
            ...
            if (session)
            {
                if (left2BTN.Text != "")
                {
                    nextStep = new DepositState(mainForm, language, left2BTN.Text);
                }
            }
            else
                theCardReader.ejectCard();
        ...
        public override State handleLeft3BTNClick()
        {
            ...
            if (session)
            {
                if (left3BTN.Text != "")
                {
                    nextStep = new DepositState(mainForm, language, left3BTN.Text);
                }
