...
namespace OceanBank
{
    class ChooseAcctToFundTransferFromState : State
    {
        //Timer
        Timer aTimer;
        int counter = 30;
        ...
        public ChooseAcctToFundTransferFromState(GUIforATM mainForm, string language) : base(mainForm, language)
        {
            aTimer = new Timer();
            ...
            {
                bigDisplayLBL.Text = "Sila pilih akaun untuk membuat pemindahan wang";
            ...
            {
                bigDisplayLBL.Text = "请选择要从中转移的帐户";
                smallDisplayLBL.Text = "";
                left1BTN.Text = ""; left2BTN.Text = ""; left3BTN.Text = ""; left4BTN.Text = "";
            ...
            {
                bigDisplayLBL.Text = "Please select an account to transfer from";
                smallDisplayLBL.Text = "";
                left1BTN.Text = ""; left2BTN.Text = ""; left3BTN.Text = ""; left4BTN.Text = "";
        ...
        public override State handleLeft1BTNClick()
        {
            ...
            if (session)
            {
                if (left1BTN.Text != "")
                {
                    nextStep = new EnterAcctNumberToFundTransferToState(mainForm, language, left1BTN.Text);
                }
            }
            else
                theCardReader.ejectCard();
        ...
        public override State handleLeft2BTNClick()
        {
            ...
            if (session)
            {
                if (left2BTN.Text != "")
                {
                    nextStep = new EnterAcctNumberToFundTransferToState(mainForm, language, left2BTN.Text);
                }
            }
            else
                theCardReader.ejectCard();
        ...
        public override State handleLeft3BTNClick()
        {
            ...
            if (session)
            {
                if (left3BTN.Text != "")
                {
                    nextStep = new EnterAcctNumberToFundTransferToState(mainForm, language, left3BTN.Text);
                }
            }
            else
                theCardReader.ejectCard();
